...
public interface BookRepository extends JpaRepository<Book, Long> {
    ...
    List<Book> findByCategoryIsNullAndTitleEqualsAndCreatedAtGreaterThanEqualAndUpdatedAtGreaterThanEqual(String name, LocalDateTime createdAt, LocalDateTime updatedAt);
